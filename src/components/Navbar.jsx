    ...
    <nav className={`${styles.nav} ${navMod}`} aria-label="Main">
      <div className={styles.bar}>
        ...
        <div className={styles.linkRail}>
          ...
          <Link to="/hosts" className={`${styles.link} ${isActive('/hosts') ? styles.active : ''}`}>Host with us</Link>
          ...
          <Link to="/help" className={`${styles.link} ${isActive('/help') ? styles.active : ''}`}>Help</Link>
          {showHostingEntry && (
